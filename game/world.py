...
class World (context.Context):
    ...
    def __init__ (self, s):
        ...
        island_list = [island.Island, acuad002_island.MysteriousIsland]
        ...
        testland = acuad002_island.MysteriousIsland(self.startx, self.starty+1, self)
        ...
        self.events.append (catfish_acuad002.Catfish())
